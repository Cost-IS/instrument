...
A worked example of Cost-IS is provided below which may assist future users. An additional user guide was produced as a result of applying Cost-IS to three real-world implementation projects as case studies (*manuscript coming soon*). Download the [Cost-IS user guide here ](https://github.com/Thomasina-Donovan/implementation-costing-instrument/raw/main/assets/AF_3_Cost-IS_UserGuide_V0.docx).
