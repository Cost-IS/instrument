...
**Watch the [ImplementEcon](https://arc-w.nihr.ac.uk/research-and-implementation/implement-econ/) webinar** below to hear me talk about:

*	why it’s important to cost implementation
*	how the Cost-IS tool was developed 
* how Cost-IS supported costing the implementation strategies of a trial
* potential implications of costing implementation


{{< video https://youtu.be/BHd1ARYBTnI?si=x-DV6z2tGfifTwZ9 >}}
...
[Download pdf](https://github.com/Thomasina-Donovan/implementation-costing-instrument/raw/main/assets/a-costing-guidebook-for-implementation-scientists-v-9-21-2023.pdf)

[Visit webpage](https://medschool.cuanschutz.edu/accords/cores-and-programs/dissemination-implementation-core/implementation-science-costing-guidebook)
...
[Economic Evaluation Alongside Implementation Studies presentation](https://implementationscience.com.au/resource/economic-evaluation-alongside-implementation-studies/)


## Understanding Implementation Costs to Improve Equitable Access to Care

In this presentation Dr. Lisa Saldana does a great job of explaining what implementation costs are and why they're important. She also provides a brief demonstration of the [Cost of Implementing New Strategies (COINS)](https://doi.org/10.1016/j.childyouth.2013.10.006) tool she created. She highlights how implementation costs can interfere with the ability for equitable implementation.

[Link to presentation](https://www.youtube.com/watch?v=KK-IVghteJQ)
...
On the **first Wednesday of every month from 10am-11am (Brisbane, AEST)**, Thomasina will be available for any questions relating to Cost-IS or costing implementation generally. 


#### Zoom details 

**Link:** [click here](https://qut.zoom.us/j/81151437760?pwd=bVZTA7dSsRugMhKjvEpcmb49WKwjRx.1&from=addon)

**Meeting ID:** 811 5143 7760

**Passcode:** 963201

*updated link on 6th Aug 2025*

# ACTA 2025 Workshop 2

## Cost-IS activity

[Acitivity sheets](https://github.com/Thomasina-Donovan/implementation-costing-instrument/raw/main/assets/ACTA25/BLANK_Case study Activity_v1.0.docx)

[Blank Cost-IS template](https://github.com/Thomasina-Donovan/implementation-costing-instrument/raw/main/assets/ACTA25/BLANK_CostIS_EDDIE_ActivityAnswers_V1.0.xlsx)

EDDIE+ trial [process evaluation](https://doi.org/10.1186/s12877-023-04491-z)


#### Answers to Cost-IS activity

[Acitivity sheets answers](https://github.com/Thomasina-Donovan/implementation-costing-instrument/raw/main/assets/ACTA25/ANSWERS_Case study Activity_v1.0.docx)

[Completed Cost-IS template](https://github.com/Thomasina-Donovan/implementation-costing-instrument/raw/main/assets/ACTA25/ANSWERS_CostIS_EDDIE_ActivityAnswers_V1.0.xlsx)

:::
:::

*Please cite the relevant journal article when referring to Cost-IS. We recommend this [article](https://doi.org/10.1186/s13012-025-01423-w).*
